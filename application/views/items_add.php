            <form action="<?=base_url("items/save");?>" method='post' name="frmadditem" id="frmadditem">
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-8">
                                    <select class="form-control" name="uom" id="uom">
                                        ...
                                        ?>
                                        <option value='<?=$rsuom->code;?>'><?=$rsuom->description;?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="row pt-1">
                                ...
                                <div class="col-8">
                                    <select class="form-control" name="lnonvat" id="lnonvat">
                                        <option value='False'>VATABLE</option>
                                        <option value='True'>NON VATABLE</option>
                                    </select>
                                </div>
                            </div>
