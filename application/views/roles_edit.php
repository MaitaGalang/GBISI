            <form action="<?=base_url("roles/update/".$roledetails->id);?>" method='post' name="frmupdaterole" id="frmupdaterole">
                <div class="modal-header">      
                    <h5 class="modal-title" id="exampleModalLabel">Update User Role Details</h5>
                ...
                <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8"><input name="title" id="title" class="form-control" type="text" placeholder="Enter Role Title..." required maxlength="50" value="<?=$roledetails->title?>"></div>
                            </div>
                            <div class="row pt-1">
                                <div class="col-4"><b>Description</b></div>
                                <div class="col-8"><input name="description" id="description" class="form-control" type="text" placeholder="Enter Role Description..." required maxlength="255" value="<?=$roledetails->description?>"></div>
                            </div>
                                                            ...
                                                            ?>
                                                                <div class="form-check-inline pl-5">  
                                                                    <div class="custom-control custom-checkbox">  
                                                                        <input name="chk_access[]" type="checkbox" class="custom-control-input" id="<?="0:".$rs->id."_".$rs_access?>" value="<?="0:".$rs->id."_".$rs_access?>" <?=$checkstat?>>  
                                                            ...
                                                            foreach($subnav_menu_all as $rssub){
                                                                if($rssub->main_id==$rs->id){
                                                                    ...
                                                                    ?>
                                                                        <div class="form-check-inline pl-5">  
                                                                            <div class="custom-control custom-checkbox">  
                                                                                <input name="chk_access[]"  type="checkbox" class="custom-control-input" id="<?=$rs->id.":".$rssub->id."_".$rs_sub_access?>" value="<?=$rs->id.":".$rssub->id."_".$rs_sub_access?>" <?=$checkstat?>>  
